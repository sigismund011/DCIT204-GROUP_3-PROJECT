    ...
    public String shortestPath(Node start, Node end) {
        ...
        while (true) {
            ...
            if (currentNode == end) {
                ...
                System.out.println("The path in km is: " + shortestPath.get(end)/100);
                System.out.println(" The time it will take is: " + (shortestPath.get(end)/2)*0.1  + " minutes");
                return path + "\n   |||     The path in km: " + (shortestPath.get(end)/100  ) + " " + "       |||   The time it will take is: " + (shortestPath.get(end)/2)*0.1 + " minutes";
            }
            currentNode.visit();
